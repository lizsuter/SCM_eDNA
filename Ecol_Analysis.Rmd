...
I am actually getting 42 unique species- which ones am I missing that should be removed?
...
**NOTES** next Sara wants the average rel abundances for each species across all dates
...
- Lacoursière‐Roussel et al. use PCoA and PERMANOVA after Hellinger transformations
