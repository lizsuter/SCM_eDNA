...
# save in "Embedded_figures" dirctory so that it can be hosted at Github and linked in this notebook
withr::with_dir('Embedded_figures', htmlwidgets::saveWidget(as_widget(pca_lograt), file="pca_lograt.html"))

```
3D plot and widget preview:
<img src="Embedded_figures/pca_lograt.html" alt="hi" class="inline"/>
