...
Summary: The PerVar explained is OK. Try a PCoA
...
Prepare the ordination variables from the PCA
```{r}
# re-run the PCA
log_transform_pca <- prcomp(CPUE_table_transform_cen_st)
...
## The only signficant variable is Station (p = 0.003996)
