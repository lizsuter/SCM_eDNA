...
I am actually getting 43 unique species. Close but not exact. **Check with Sara** if there are some more that should be removed
...
```{r}
ggsave(filename = "Figures/speciesbubbleplot.eps", plot = speciesbubbleplot, units = c("in"), width = 9, height = 14, dpi = 300, )
```
