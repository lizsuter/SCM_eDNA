...
For plotting, use *relative abundances*, calculated easily using microbiome::transform
...
```
*NOTES* for Sara
- the positive controls seem to be all the same family- I assume this is OK and from this point on we can just remove them
- there are some suspicious samples, (T1S3, T1S6, T2S11, T3S10, T3S4, T3S5, T3S9, T4S4, T4S7, T5S7 which are composed almost exclusively of 1 family. This might be fine, but I'm not used to seeing this with proakroytic data. Just to make you aware
