...
### Plt abundance of families from all samples to do some quality control
...
### Bubble plots
Plot species using bubble plots to differentiate patterns across sample types
Partly based on [this](https://towardsdatascience.com/how-to-give-life-to-your-microbiome-data-using-plotly-r-1892281183cf) and 
```{r}
...
y
y$data
# I think that y$data exports the underlying matrix of data that goes into the heatmap- try to play with this 
```
