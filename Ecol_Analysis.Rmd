...
```{r}
# Import
trawl_CPUE <- read_excel("Trawl CPUE no elasmobranch_mod.xlsx")
...
```{r}
speciesbubbleplot_trawl_comname <- ggplot(trawl_CPUE, aes(x = Station, y = fct_rev(Species), color = Station)) + 
...
##STOPPED HERE MAY 3RD. KEEP FIXIN SYNTAC BASED ON NEW CPUE TABLE
