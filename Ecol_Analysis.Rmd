...
```{r}
count_table_matrix <- as.matrix(count_table[,2:55]) # convert count table to matrix, leaving out character column of sample ID
...
```
Most samples look like they were sampled to completion. Be weary of T5S7, T4S5, T1S2, T3S2 and maybe T3S3
...
```
All are in Eukaryota domain, that's good. Also check and all are in phylum Chordata and class Actinopteri
